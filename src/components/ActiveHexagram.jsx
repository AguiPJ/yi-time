 ...
 */
export default function ActiveHexagram({ result, isManual }) {
  if (!result) {
    return (
    ...
    <div className="active-hex">
      ...
      <div className="active-hex__row">
        <div className="active-hex__gua active-hex__gua--main">
          <span className="active-hex__gua-label">本卦</span>
        ...
        <div className="active-hex__arrow">→</div>

        <div className="active-hex__gua active-hex__gua--changed">
          <span className="active-hex__gua-label">变卦</span>
        ...
        <div className="active-hex__gua active-hex__gua--mutual">
          <span className="active-hex__gua-label">互卦</span>
